...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2025-06-20T19:52:07Z"), u1);
		Order o2 = new Order(null, Instant.parse("2025-07-21T09:12:50Z"), u2);
		Order o3 = new Order(null, Instant.parse("2025-07-22T11:32:11Z"), u1);
